package net.hayden.shung.screen;
...
public class ShungiteStoveMenu extends AbstractContainerMenu {
    public final ShungiteStoveBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public ShungiteStoveMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, ModBlocks.SHUNGITE_STOVE.get());
    }
